...
bipok = 'Alarme OFF'
i = 0
liquide = ['The vert', 'The noir', 'The blanc', 'Thé Oolong', 'Rooibos', 'Cafe instantane', 'cafe filtre', 'Lait pour yaourt / eau pate a pizza', 'Bain', 'Eau bouillante / tisane', 'Glace', 'Sucre filet', 'Sucre petit boule']
